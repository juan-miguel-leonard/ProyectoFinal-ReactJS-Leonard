        ...
        <>
            ...
            <div className="row my-1">
                <div className="col-md-5">
                    {itemAdded ? <Link to={"/cart"} className="btn btn-primary">Finalizar mi compra</Link> : <button type="button" className="btn btn-primary" onClick={addToCart}>Añadir al Carrito</button>}
                </div>
            </div>
        </>
    )
