                ...
                <div className="row">
                    <div className="col text-center">
                        ...
                        <table className="table">
                            <tbody>
                                <tr>
                                    <td className="text-end align-middle" colSpan={6}><a href="#" onClick={clear} className="btn btn-primary">Vaciar Carrito <img src={trash} alt="Eliminar Producto" title="Eliminar Producto" /></a></td>
                                </tr>
                                {cart.map(product =>
                                    <tr key={product.id}>
                                ...
                                <tr>
                                    ...
                                    <td className="text-end align-middle"><Link to={"/checkout"} className="btn btn-primary">Checkout</Link></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
