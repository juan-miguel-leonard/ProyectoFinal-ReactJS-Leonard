    ...
    return (
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-6">
                    <form>
                        ...
                        <button type="button" className="btn btn-primary" onClick={generarOrden}>Generar solicitud</button>
                    </form>
                </div>
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ? <div className="alert alert-primary p-5 text-center" role="alert">
                        <p className="display-1">🔧</p>
                        <h1>Gracias por tu Compra!</h1>
                        <p>Este es tu codigo ID de Compra: <b>{orderId}</b></p>
                    </div> : ""}
                </div>
            </div>
        </div>
